...
submitName.addEventListener('click', () => {
  ...
  apologyText.innerHTML = `Aku gak bermaksud bikin sakit hati, udah yaa marahnya jangan cuekin aku lagi 🥺.<br>Maafin aku, ya? 😢`;
});
...
yesBtn.addEventListener('click', () => {
  ...
  popupMsg.textContent = `Aku janji gak bakal gitu lagi 🥺✨`;
  generateHearts();
  setTimeout(() => {
